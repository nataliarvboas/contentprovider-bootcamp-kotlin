package com.example.contentprovider_bootcamp_kotlin.database
...
import com.example.contentprovider_bootcamp_kotlin.database.NotesDatabaseHelper.Companion.TABLE_NOTES
...
class NotesProvider : ContentProvider() {
    ...
    @RequiresApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
    override fun getType(uri: Uri): String? = throw UnsupportedSchemeException("Uri nao implementada")
...
override fun query(
    ...
    companion object {
        const val AUTHORITY = "com.example.contentprovider_bootcampkotlin.provider"
